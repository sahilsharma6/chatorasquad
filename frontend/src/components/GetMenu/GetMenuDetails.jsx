    ...
    <>
      <div className="md:w-1/2 shadow-xl py-8 px-6 bg-white rounded-xl transition-all duration-300 hover:shadow-2xl">
        ...
        <div className="mt-8 border-t pt-4">
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className={`mt-2 transition-all duration-300 overflow-hidden ${isDescriptionExpanded ? "max-h-96" : "max-h-0"
                }`}>
        ...
        <div className="flex gap-4 mt-8 sticky">
          ...
          <button
            className={`flex-1 bg-gray-900 text-white py-4 rounded-xl font-semibold transition-all duration-300 
  ${!isAvailable ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-800 hover:shadow-lg hover:-translate-y-1'}`}
