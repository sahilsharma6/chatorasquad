...
function Work() {
  return (
    <div className="bg-gradient-to-b from-orange-50 to-white  w-full h-auto p-20 md:p-10 pb-0 flex flex-col items-center">
      ...
      <div className="flex flex-col items-center p-6">
          ...
          <h3 className="text-xl font-semibold mt-4 text-orange-500">Choose order</h3>
        ...
        <div className="flex flex-col items-center p-6 ">
          ...
          <h3 className="text-lg font-semibold mt-4 text-orange-500">Select location</h3>
          <p className="text-lg text-gray-600 p-4">
        ...
        <div className="flex flex-col items-center p-6">
          ...
          <h3 className="text-lg font-semibold mt-4 text-orange-500">Pay advanced</h3>
        ...
        <div className="flex flex-col items-center p-6">
          ...
          <h3 className="text-lg font-semibold mt-4 text-orange-500">Enjoy meals</h3>
          <p className="text-sm text-gray-600 p-4">
