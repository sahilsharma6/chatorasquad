...
const OrdersTable = () => {
  ...
  const data = [
    { id: 8, DishesName: 'Implied contract', Name: 'Urban Gallery', email: 'Name@testing.com', phone: '999-000-989-0', value: 44000, Date: '2024-08-22' },
    { id: 5, DishesName: 'Unit price contract', Name: 'Trendy Scissor', email: 'Name@testing.com', phone: '222-312-222-9', value: 54000, Date: '2024-06-23' },
    { id: 9, DishesName: 'Express contract', Name: 'The Spice Route', email: 'Name@testing.com', phone: '554-444-999-3', value: 87000, Date: '2024-04-12' },
    { id: 6, DishesName: 'Bilateral contract', Name: 'The Fresh Breakfast', email: 'Name@testing.com', phone: '772-009-989-1', value: 43000, Date: '2024-01-12' },
    { id: 13, DishesName: 'Aleatory contract', Name: 'The First Step', email: 'Name@testing.com', phone: '112-222-887-7', value: 62000, Date: '2024-03-12' },
    { id: 4, DishesName: 'Time and materials contract', Name: 'Ready Continental', email: 'Name@testing.com', phone: '565-676-889-0', value: 33000, Date: '2024-04-12' },
    { id: 2, DishesName: 'Cost-reimbursement contract', Name: 'Hellow World Kids', email: 'Name@testing.com', phone: '887-332-090-2', value: 25000, Date: '2024-03-21' }
  ];
  ...
  return (
    ...
    >
      ...
      <Data handleSort={handleSort} paginatedData={paginatedData} />
