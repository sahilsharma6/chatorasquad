...
const ViewCuisine = () => {
  ...
  const [cuisines, setCuisines] = useState([
    { name: 'Italian', date: '2024-12-25' },
    { name: 'Mexican', date: '2024-12-24' },
    { name: 'Indian', date: '2024-12-23' },
    { name: 'Chinese', date: '2024-12-22' },
  ]);
      ...
      {isModalOpen && (
        ...
        >
          ...
          <div className="flex justify-between">
            <h2 className="text-xl font-bold mb-4">Edit Cuisine</h2> <X size={33} onClick={() => setIsModalOpen(false)}
                className="cursor-pointer hover:bg-yellow-200 transition-all delay-100 rounded-full" /> </div>
