        ...
        <div className="w-full max-w-full bg-white rounded-2xl shadow-2xl flex flex-col md:flex-row overflow-hidden ">
          ...
          >
            <form className="space-y-6">
              ...
              >
                <input
                  type="checkbox"
                  className="w-4 h-4 accent-yellow-500 bg-white checked:text-white transition-all"
                />
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Feel free to reach out to us for any queries or feedback. We are
              here to help!
            </p>
