        ...
        <section className="space-y-8">
          <div>
            ...
            <p className="mt-4 text-lg">
              At ChatoraSquad, we are committed to protecting your privacy and
          ...
          <div>
            ...
            <ul className="list-inside list-disc mt-4 text-lg">
              <li>
                ...
                address, phone number, and other identifying information when
                you make a purchase or create an account.
              </li>
              <li>
                <strong>Payment Information:</strong> Credit card details or
                other payment information for processing orders.
              </li>
              <li>
              ...
              <li>
                <strong>Communication Data:</strong> Data you provide when
                contacting our customer support or subscribing to our
                newsletters.
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="list-inside list-disc mt-4 text-lg">
              <li>
                <strong>Processing Orders:</strong> To fulfill your orders,
                process payments, and provide customer support.
              </li>
              <li>
                <strong>Communication:</strong> To send order updates,
          ...
          <div>
            ...
            <ul className="list-inside list-disc mt-4 text-lg">
              <li>
                ...
                providers to assist in business operations.
              </li>
              <li>
                <strong>Legal Compliance:</strong> To comply with legal
                requirements, such as responding to subpoenas or government
                requests.
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="list-inside list-disc mt-4 text-lg">
              ...
              <li>
                <strong>Rectification:</strong> You can request corrections to
                inaccuracies in your data.
              </li>
              <li>
                <strong>Erasure:</strong> You can request the deletion of your
          ...
          <div>
            ...
            <p className="mt-4 text-lg">
              ...
              needed, with changes being effective immediately upon posting on
              our website.
            </p>
          </div>
